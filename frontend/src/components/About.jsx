      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className={`transition-all duration-700 ${
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-[hsl(4,75%,50%)] to-[hsl(45,100%,47%)] mb-6"></div>
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="text-center p-5 bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                <div className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-[hsl(4,75%,50%)] to-[hsl(45,100%,47%)] bg-clip-text text-transparent mb-1">
                  20+
                </div>
