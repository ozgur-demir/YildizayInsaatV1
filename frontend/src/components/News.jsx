...
const News = () => {
  ...
  return (
    <section id="news" className="py-20 bg-[hsl(210,12%,95%)]" ref={sectionRef}>
            ...
            >
              <div className="relative pb-[60%] overflow-hidden">
                <img 
                  ...
                  loading="lazy"
                />
                <span className="absolute top-4 right-4 bg-gradient-to-r from-[hsl(4,75%,50%)] to-[hsl(4,75%,40%)] text-white px-4 py-2 rounded-lg text-sm font-semibold shadow-lg">
                  {article.date}
                </span>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-800 mb-3 group-hover:text-[hsl(4,75%,50%)] transition-colors">
                  {article.title}
                </h3>
                ...
                <a 
                  href="#" 
                  className="inline-flex items-center text-[hsl(4,75%,50%)] font-semibold hover:gap-2 transition-all group"
