      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center rounded-full bg-gradient-to-br from-orange-50 to-orange-100 group-hover:from-[hsl(4,75%,50%)] group-hover:to-[hsl(45,100%,47%)] transition-all duration-300">
                <div className="w-9 h-9 text-[hsl(4,75%,50%)] group-hover:text-white transition-colors">
                  {service.icon}
                </div>
              </div>
